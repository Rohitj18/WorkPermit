          ...
          <div className="w-[30%]  h-[100%] rounded-xl p-5 text-white gap-2 bg-[#263043] m-3 inline-block" key={index}>
            <div className=' w-[100%] h-[100%] flex flex-col gap-3 items-center justify-center'>
              ...
              <div className='flex flex-col w-[100%] mb-3'>
                <p>Status :</p>
                {
                  form.isDissApproved === false ? (<div className='flex flex-col gap-2 mb-5'>
                    <div>
                  ...
                  </div>) : (<p className='font-bold ml-5 bg-[#1d2634] text-center rounded-lg text-xl mt-3 py-2'>Disaprroved</p>)
                }

                {
                  isAdmin1 && form.reqDocsSubmit === false && form.isDissApproved===false ? (
                ...
                {
                  isAdmin === false && form.reqDocsSubmit === true ? (<div className=' mx-auto flex flex-col w-[18rem] h-[5rem] bg-red-500'>
                    {
                      <div className='w-[100%] h-[100%]'>{form.requiredDocs.reqDocs.map((object, index) => (
                        <div className='flex flex-row gap-5 w-[100%]' key={index}>
                          <p>{object}</p>
                          {
                ...
                {
                  isAdmin === true && form.reqDocsSubmit === true && form.requiredDocs.reqDocs.length === Object.keys(form.requiredDocs.submitedDocs).length ? (<div className=' mx-auto flex flex-col w-[18rem] h-[5rem] bg-red-500'>
                    {
                      <div className='w-[100%] h-[100%]'>{form.requiredDocs.reqDocs.map((object, index) => (
                  ...
                  isAdmin === true ? (
                    <div className='w-[66.66%] h-[100%] flex justify-center items-center'>
                      ...
                      }
                      {
                        isAdmin3 ? (
                          <div className='flex gap-3 w-[100%] h-[100%] justify-center items-center'>
                            <button disabled={form.approve3 === true ? true : false} className={`${form.approve3 === true ? "disabled:opacity-75" : ""} ${form.isDissApproved === true ? "invisible" : ""} flex justify-center items-center w-[50%] h-[80%] bg-green-500 rounded-lg`} id={`${form.formID._id}`} onClick={admin1Approval}>{form.approve1 === true ? "Approved" : "Approve"}</button>
